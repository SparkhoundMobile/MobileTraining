...
namespace Mymdb.WinRT.Views
{
    ...
    public sealed partial class Movies : Page
    {
        ...
        public Movies()
        {
            ...
            this.ViewModel = new MoviesViewModel();
            ...
            this.navigationHelper.GoBackCommand = new Mymdb.WinRT.Common.RelayCommand(() => this.GoBack(), () => this.CanGoBack());
